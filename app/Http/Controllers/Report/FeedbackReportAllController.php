...
class FeedbackReportAllController extends Controller
{
    ...
    /* API Section Product */
    public function getAllProductReportYearly($tenant_id, $customer_rating, $year, $count) {
    ...
    public function getAllProductReportMonthly($tenant_id, $customer_rating, $year, $month, $count) {
