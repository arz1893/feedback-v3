...
class CreateFeedbackListCrudRightsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('feedback_list_crud_rights', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('feedback_list_crud_rights');
    }
}
