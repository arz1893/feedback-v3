...
class CreateQuestionCrudRightsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('question_crud_rights', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('question_crud_rights');
    }
}
