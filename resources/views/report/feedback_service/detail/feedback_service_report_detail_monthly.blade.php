...
@push('scripts')
    ...
    <script src="{{ asset('js/chartjs/feedback_service/detail/feedback_service_report_detail_monthly.js') }}" type="text/javascript"></script>
@endpush

@section('content-header')
    <h3 style="margin-top: -0.5%;" class="text-info">Report Detail (Monthly)</h3>
    <ol class="breadcrumb">
...
@section('main-content')
    ...
    <div class="btn-group" role="group" aria-label="...">
        ...
        <a href="{{ route('feedback_service_report_detail_yearly', $service->systemId) }}" role="button" class="btn btn-xs btn-default">Yearly</a>
    </div> <br> <br>
    ...
    <div class="container">
        ...
        <canvas id="feedback_service_chart_detail_monthly" style="height:55vh; width:80vw"></canvas>
    </div>
@endsection