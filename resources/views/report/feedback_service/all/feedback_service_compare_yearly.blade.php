...
@push('scripts')
    ...
    <script src="{{ asset('js/chartjs/feedback_service/all/feedback_service_compare_yearly.js') }}" type="text/javascript"></script>
@endpush

@section('content-header')
    <h3 style="margin-top: -0.5%;" class="text-info">All Feedback Service Comparison in <span id="current_year"></span></h3>
    <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{ url('/feedback_report_selection') }}"><i class="fa fa-pie-chart"></i> Feedback Report Selection</a></li>
        <li class="active"> All Feedback Service Comparison (Yearly) </li>
    </ol>
@endsection
...
@section('main-content')
    ...
    <div class="btn-group" role="group" aria-label="...">
        ...
        <a href="{{ route('feedback_service_compare_monthly') }}" role="button" class="btn btn-xs btn-default">Monthly</a>
    ...
    <div class="chart-container">
        <canvas id="feedback_service_comparison_yearly" height="125"></canvas>
    </div>
@endsection