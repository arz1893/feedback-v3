...
@section('content-header')
    <h3 style="margin-top: -0.5%;" class="text-info">Top Feedback Service in <span id="current_year"></span></h3>
    <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{ url('/feedback_report_selection') }}"><i class="fa fa-pie-chart"></i> Feedback Report Selection</a></li>
        <li class="active"> Top Service (Yearly) </li>
    </ol>
@endsection
...
@section('main-content')
    ...
    <div class="btn-group" role="group" aria-label="...">
        ...
        <a role="button" href="{{ route('feedback_service_report_top_monthly') }}" class="btn btn-xs btn-default">Monthly</a>
    ...
    <div class="chart-container">
        <canvas id="feedback_report_all_service_yearly" height="275" width="800"></canvas>
    </div>
