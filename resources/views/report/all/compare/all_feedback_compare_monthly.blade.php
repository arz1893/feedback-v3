...
@push('scripts')
    ...
    <script src="{{ asset('js/chartjs/all/compare/all_feedback_compare_monthly.js') }}" type="text/javascript"></script>
@endpush

@section('content-header')
    <h3 style="margin-top: -0.5%;" class="text-info">All Feedback Comparison in <span id="current_month"></span> <span id="current_year"></span></h3>
    <ol class="breadcrumb">
...
@section('main-content')
    ...
    <div class="btn-group" role="group" aria-label="...">
        ...
        <a href="{{ route('all_feedback_compare_yearly') }}" role="button" class="btn btn-xs btn-default">Yearly</a>
    </div> <br> <br>
    ...
    <div class="chart-container">
        <canvas id="all_feedback_comparison_monthly"></canvas>
    </div>
@endsection