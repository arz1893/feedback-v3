...
@push('scripts')
    ...
    <script src="{{ asset('js/chartjs/all/global/feedback_global_report_all_monthly.js') }}" type="text/javascript"></script>
@endpush

@section('content-header')
    <h3 style="margin-top: -0.5%;" class="text-info">All Global Feedback in <span id="current_month"></span> <span id="current_year"></span></h3>
    <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{ url('/feedback_report_selection') }}"><i class="fa fa-pie-chart"></i> Feedback Report Selection</a></li>
        <li class="active"> All Global Feedback (Monthly) </li>
    </ol>
@endsection
...
@section('main-content')
    ...
    <div class="btn-group" role="group" aria-label="...">
        ...
        <a href="{{ route('all_global_feedback_yearly') }}" role="button" class="btn btn-xs btn-default">Yearly</a>
    </div> <br> <br>
    ...
    <div class="col-lg-12">
        <canvas id="all_global_feedback_monthly"></canvas>
    </div>
