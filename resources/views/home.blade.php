        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                @if(Auth::user()->user_group->getFeedbackProductCrudRights->view == 1)
                                    <li><a role="button" href="{{ route('feedback_product.index') }}"><i class="fa fa-commenting"></i> Feedback Product</a></li>
                                @endif
                                @if(Auth::user()->user_group->getFeedbackServiceCrudRights->view == 1)
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        @if(Auth::user()->user_group->getFeedbackProductListCrudRights->view == 1 || Auth::user()->user_group->getFeedbackServiceListCrudRights->view == 1)
                            <li class="treeview">
                                <a href="#!">
                                ...
                                <ul class="treeview-menu">
                                    @if(Auth::user()->user_group->getFeedbackProductListCrudRights->view == 1)
                                        <li><a role="button" href="{{ route('feedback_product_list.index') }}"><i class="ion ion-ios-list-outline"></i> Feedback Product List</a></li>
                                    @endif
                                    @if(Auth::user()->user_group->getFeedbackServiceListCrudRights->view == 1)
