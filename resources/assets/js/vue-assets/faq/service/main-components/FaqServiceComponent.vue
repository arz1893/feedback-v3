    ...
    <div>
        <div class="media">
            ...
            <div class="media-body">
                ...
                <button v-if="user_rights.create === 1" class="btn btn-primary" data-toggle="modal" data-target="#modal_faq_service" style="margin-top: 0.8%;" @click="addTypeSubmit('add', 'Add FAQ')">
                ...
                <div class="box box-primary box-solid" v-for="faq in faqServices">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <button v-if="user_rights.edit === 1" type="button" class="btn btn-box-tool" data-toggle="modal" data-target="#modal_faq_service" @click="editFaqService(faq)"><i class="fa fa-pencil-square"></i></button>
                            <button v-if="user_rights.delete === 1" type="button" class="btn btn-box-tool" data-toggle="modal" data-target="#modal_delete_faq_service" @click="setDeleteTarget(faq)"><i class="fa fa-trash-o"></i></button>
                        </div>
                        <!-- /.box-tools -->
                    </div>
                    <!-- /.box-header -->
